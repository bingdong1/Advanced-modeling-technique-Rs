...
weighted.acc(pred_train,data_train$coverType) #0.7831125   
confusionMatrix(pred_train, data_train$coverType) #0.6555
...
weighted.acc(pred_test,data_test$coverType) #0.7841572 
confusionMatrix(pred_test, data_test$coverType) #0.6569
