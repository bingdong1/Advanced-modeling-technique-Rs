...
# Save everything 
save(results, file=paste0("G:/Employee Folders/Dong Bing//ann.resultsStandardSample.RData")) 
save(models, file=paste0("G:/Employee Folders/Dong Bing//ann.modelsStandardSample.RData")) 
save(best.ann, file=paste0("G:/Employee Folders/Dong Bing//best.annStandardSample.RData")) 
write.table(results, file=paste0("G:/Employee Folders/Dong Bing//ann.resultsStandardSample.csv"), sep=",") 
